package manageo.restaurant.configuration;
...
public class ReservationApplicationConfiguration {
    ...
    ServiceInstanceListSupplier serviceInstanceListSupplier() {
      return new ReservationApplictionInstanceListSuppler("restaurant");
    }
    ...
    class ReservationApplictionInstanceListSuppler implements ServiceInstanceListSupplier {
        ...
        public Flux<List<ServiceInstance>> get() {
          return Flux.just(Arrays
              .asList(new DefaultServiceInstance(serviceId + "1", serviceId, "localhost", 9090, false),
